...
const existing = await Prisma.user.findFirst({select:{id:true},where:{email:email}})
    ...
    const token = jwt.sign(
      { id: usersignup.rows[0].id, email: usersignup.rows[0].email , role:usersignup.rows[0].role},
